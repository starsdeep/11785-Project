...
class CrossEntropyProp(mx.operator.CustomOpProp):
    ...
    def infer_shape(self, in_shape):
        # print('CE infer_shape', in_shape)
        if in_shape[0][0] != in_shape[1][0] or in_shape[0][-1] != in_shape[1][-1]:
            raise ValueError("Input shapes dismatch. data:%s. label:%s. must be same"
